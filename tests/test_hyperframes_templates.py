...
136 шаблонов каталога — это рендереры с параметрами. Проверяется то, что
...
from src.lib.render.hyperframes.templates import (
    ...
    _gw_times, _ll_times, _si_times, _td_times, _wp_times, _cw_times, _t3_times, _tb_times, _tc_times, _tds_times, _tlt_times, _sr_frame_table,
)

...
Палитра канала — чёрный, белый и красный: ``#E5322D``, ``#FF6A5F``, ``#9C1B17``,
...
# (`accent #E5322D` → hue ≈ 2°, `cyan` — бирюза `#19E6D2` → hue ≈ 174°) и расширены ровно
...
ACCENT_CORRIDORS = {
    ...
    "cyan": {"hue": (156.0, 196.0), "sat_min": 0.35, "value_min": 0.35},
}
...
def overlay_uses_cyan(overlay: dict[str, Any],
    ...
    if not cyan_tokens:
        cyan_tokens = ["#19E6D2", "#7FF5EA", "#0B9E90"]

...
Палитра канала — чёрный, белый и красный: ``#D7263D`` и тёмный ``#8E1627``
(светло-красного нет — заказчик 23.09), оба стоят на оттенке 3–4°. Золото и жёлтый из референсов в неё не входят
...
# (`accent #D7263D` → hue ≈ 352°, бирюза `cyan #36EFFF` → hue ≈ 185°) и расширены ровно

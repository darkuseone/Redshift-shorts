...
#
# Короткие звуки тоже больше не доливаются в библиотеку: двадцать синтетических
# wav заказчик снял, чтобы залить свои. Рецепты ниже остаются словарём ролей
# (§14.1) и материалом тестов; ``fill_sfx`` их не вызывает.

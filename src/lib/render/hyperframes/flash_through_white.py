...
def ftw_transition_css() -> str:
    ...
    return (
        ...
        ".tr-flash-through-white .ftw-from{background:#03071e;color:#ffba08;opacity:0}"
        ".tr-flash-through-white .ftw-to{background:#ffba08;color:#03071e;opacity:0}"
        ...
        "background:radial-gradient(circle at 50% 50%,rgba(255,186,8,0.7) 0%,rgba(255,255,255,0.4) 40%,transparent 70%);"

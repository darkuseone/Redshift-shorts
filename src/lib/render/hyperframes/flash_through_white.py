...
def ftw_transition_css() -> str:
    ...
    return (
        ...
        ".tr-flash-through-white .ftw-from{background:#111214;color:#D7263D;opacity:0}"
        ".tr-flash-through-white .ftw-to{background:#D7263D;color:#ffffff;opacity:0}"
        ...
        "background:radial-gradient(circle at 50% 50%,rgba(215,38,61,0.7) 0%,rgba(255,255,255,0.4) 40%,transparent 70%);"

...
def rb_transition_css() -> str:
    ...
    return (
        ...
        ".tr-ridged-burn .rb-from{background:#111214;color:#E5322D;opacity:0}"
        ".tr-ridged-burn .rb-to{background:#E5322D;color:#ffffff;opacity:0}"
        ...
        "background:radial-gradient(circle at 50% 50%,rgba(255,255,255,0.85) 0%,rgba(255,106,95,0.75) 25%,rgba(229,50,45,0.8) 50%,transparent 72%);"
        "mix-blend-mode:screen;opacity:0}"
        ".tr-ridged-burn .rb-sparks{"
        "background:radial-gradient(circle at 35% 45%,rgba(247,245,243,0.8) 0%,transparent 12%),"
        "radial-gradient(circle at 65% 55%,rgba(255,106,95,0.75) 0%,transparent 15%),"
        "radial-gradient(circle at 50% 30%,rgba(229,50,45,0.8) 0%,transparent 14%);"
        "mix-blend-mode:screen;opacity:0}"
    )

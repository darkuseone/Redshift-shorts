...
def nc_overlay_css() -> str:
    ...
    return (
        ...
        "background:radial-gradient(ellipse 120% 90% at 50% 42%,transparent 55%,rgba(10,10,12,0.45) 100%)}"
        ...
        "color:#111214;box-shadow:0 8px 24px rgba(17,18,20,0.18);backdrop-filter:blur(16px)}"
        ...
        "box-shadow:0 8px 24px rgba(17,18,20,0.18);backdrop-filter:blur(16px)}"

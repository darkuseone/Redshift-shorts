...
def tm_transition_css() -> str:
    ...
    return (
        ...
        ".tr-transitions-mechanical .tm-a{background:#1b263b;opacity:0}"
        ".tr-transitions-mechanical .tm-b{background:#e07a5f;opacity:0}"
        ...
        ".tr-transitions-mechanical .tm-a .tm-label{color:#778da9}"
        ...
        "background:linear-gradient(180deg,#111214 0%,#181a1f 92%,#e07a5f 100%)}"
        ".tr-transitions-mechanical .tm-shutter-bot{bottom:0;"
        "background:linear-gradient(0deg,#111214 0%,#181a1f 92%,#e07a5f 100%)}"
        ".tr-transitions-mechanical .tm-shutter-lip{position:absolute;left:0;right:0;height:4px;"
        "background:#e07a5f;display:block}"
        ...
        "box-shadow:0 0 24px #e07a5f,0 0 48px rgba(224,122,95,0.6);opacity:0;z-index:52}"
    )

...
def tm_transition_css() -> str:
    ...
    return (
        ...
        ".tr-transitions-mechanical .tm-b{background:#D7263D;opacity:0}"
        ...
        "background:linear-gradient(180deg,#111214 0%,#111214 92%,#D7263D 100%)}"
        ".tr-transitions-mechanical .tm-shutter-bot{bottom:0;"
        "background:linear-gradient(0deg,#111214 0%,#111214 92%,#D7263D 100%)}"
        ".tr-transitions-mechanical .tm-shutter-lip{position:absolute;left:0;right:0;height:4px;"
        "background:#D7263D;display:block}"
        ...
        "box-shadow:0 0 24px #D7263D,0 0 48px rgba(215,38,61,0.6);opacity:0;z-index:52}"
    )

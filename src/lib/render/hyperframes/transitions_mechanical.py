...
def tm_transition_css() -> str:
    ...
    return (
        ...
        ".tr-transitions-mechanical .tm-b{background:#E5322D;opacity:0}"
        ...
        "background:linear-gradient(180deg,#111214 0%,#111214 92%,#E5322D 100%)}"
        ".tr-transitions-mechanical .tm-shutter-bot{bottom:0;"
        "background:linear-gradient(0deg,#111214 0%,#111214 92%,#E5322D 100%)}"
        ".tr-transitions-mechanical .tm-shutter-lip{position:absolute;left:0;right:0;height:4px;"
        "background:#E5322D;display:block}"
        ...
        "box-shadow:0 0 24px #E5322D,0 0 48px rgba(229,50,45,0.6);opacity:0;z-index:52}"
    )

...
def sc_overlay_css() -> str:
    ...
    return (
        ...
        "background:linear-gradient(165deg,#1a222c 0%,#121820 45%,#0b1016 100%);"
        "border-radius:28px;padding:36px;border:1px solid rgba(255,255,255,0.28);"
        ...
        ".spotify-card .sc-artist-name{font-size:34px;font-weight:400;color:rgba(255,255,255,0.92);"
        ...
        ".spotify-card .sc-brand-text{font-size:26px;font-weight:600;color:rgba(255,255,255,0.88);letter-spacing:0.01em}"
    )

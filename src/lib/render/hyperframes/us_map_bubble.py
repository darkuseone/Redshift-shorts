...
def umb_css() -> str:
    return (
        ...
        ".umb-bubble{position:absolute;background:radial-gradient(circle at 30% 30%, #FF6A5F, #E5322D);border-radius:50%;box-shadow:0 0 20px rgba(229,50,45,0.5);mix-blend-mode:screen}"

...
def umb_css() -> str:
    return (
        ...
        ".umb-bubble{position:absolute;background:radial-gradient(circle at 30% 30%, #F2566B, #D7263D);border-radius:50%;box-shadow:0 0 20px rgba(215,38,61,0.5);mix-blend-mode:screen}"

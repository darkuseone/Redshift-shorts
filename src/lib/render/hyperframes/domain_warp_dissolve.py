...
def dwd_transition_css() -> str:
    ...
    return (
        ...
        ".tr-domain-warp-dissolve .dwd-from{background:#111214;color:#E5322D;opacity:0}"
        ".tr-domain-warp-dissolve .dwd-to{background:#E5322D;color:#ffffff;opacity:0}"
        ...
        ".tr-domain-warp-dissolve .dwd-glow{"
        "background:radial-gradient(circle at 50% 50%,rgba(229,50,45,0.6) 0%,rgba(156,27,23,0.5) 45%,transparent 70%);"

...
def dwd_transition_css() -> str:
    ...
    return (
        ...
        ".tr-domain-warp-dissolve .dwd-from{background:#111214;color:#D7263D;opacity:0}"
        ".tr-domain-warp-dissolve .dwd-to{background:#D7263D;color:#ffffff;opacity:0}"
        ...
        ".tr-domain-warp-dissolve .dwd-glow{"
        "background:radial-gradient(circle at 50% 50%,rgba(215,38,61,0.6) 0%,rgba(142,22,39,0.5) 45%,transparent 70%);"

...
def dwd_transition_css() -> str:
    ...
    return (
        ...
        ".tr-domain-warp-dissolve .dwd-from{background:#111214;color:#C8453D;opacity:0}"
        ".tr-domain-warp-dissolve .dwd-to{background:#C8453D;color:#ffffff;opacity:0}"
        ...
        ".tr-domain-warp-dissolve .dwd-glow{"
        "background:radial-gradient(circle at 50% 50%,rgba(200,69,61,0.6) 0%,rgba(142,47,42,0.5) 45%,transparent 70%);"

...
def transition_css(brandbook: dict[str, Any]) -> str:
    ...
    return (
        ...
        ".tr-cinematic-zoom .cz-to{background:#C8453D;mix-blend-mode:overlay}"
        ".tr-cinematic-zoom .cz-r{inset:-18%;border-radius:50%;"
        "background:radial-gradient(circle,rgba(200,69,61,0.72) 0%,transparent 58%);"
        "mix-blend-mode:screen}"
        ".tr-cinematic-zoom .cz-b{inset:-14%;border-radius:50%;"
        "background:radial-gradient(circle,rgba(228,114,106,0.65) 0%,transparent 58%);"
        "mix-blend-mode:screen}"
        ...
        ".tr-glitch-shader .gs-to{background:#C8453D;mix-blend-mode:overlay}"
        ...
        ".tr-glitch-shader .gs-r{background:#C8453D;mix-blend-mode:screen}"
        ".tr-glitch-shader .gs-b{background:#E4726A;mix-blend-mode:screen}"
        ".tr-glitch-shader .gs-scan{position:absolute;left:-12%;width:124%;"
        "display:block;opacity:0;background:rgba(200,69,61,0.5);"
        "mix-blend-mode:overlay}"
        ".tr-glitch-shader .gs-block{position:absolute;display:block;opacity:0;"
        "background:rgba(228,114,106,0.35);mix-blend-mode:screen}"
        ...
        ".tr-gravitational-lens .gw-to{background:#C8453D;mix-blend-mode:overlay}"
        ...
        "background:radial-gradient(circle,rgba(200,69,61,0.78) 0%,transparent 58%);"
        "mix-blend-mode:screen}"
        ".tr-gravitational-lens .gw-b{inset:-12%;border-radius:50%;"
        "background:radial-gradient(circle,rgba(142,47,42,0.62) 0%,transparent 58%);"
        "mix-blend-mode:screen}"
        ".tr-gravitational-lens .gw-ghost{"
        "background:radial-gradient(circle,rgba(200,69,61,0.2) 0%,transparent 70%);"
        "mix-blend-mode:screen}"
        ...
        ".tr-light-leak .ll-to{background:#C8453D;mix-blend-mode:overlay}"
        ".tr-light-leak .ll-sage{background:#8E2F2A;mix-blend-mode:overlay}"
        ".tr-light-leak .ll-blob{inset:-48% -38% 18% 12%;border-radius:50%;"
        "background:radial-gradient(circle at 78% 22%,"
        "rgba(255,255,255,0.95) 0%,rgba(200,69,61,0.78) 34%,"
        "rgba(228,114,106,0.28) 58%,transparent 74%);"
        "mix-blend-mode:screen}"
        ".tr-light-leak .ll-hot{inset:-18% -12% 62% 48%;border-radius:50%;"
        "background:radial-gradient(circle,rgba(228,114,106,0.9) 0%,transparent 62%);"
        "mix-blend-mode:screen}"
        ...
        "rgba(228,114,106,0) 38%,rgba(228,114,106,0.88) 50%,"
        "rgba(200,69,61,0.5) 58%,transparent 78%);"
        "mix-blend-mode:screen;transform-origin:50% 50%}"
        ".tr-light-leak .ll-o0{inset:-36% -18% 48% 28%;border-radius:50%;"
        "background:radial-gradient(circle,rgba(200,69,61,0.4) 0%,transparent 70%);"
        "mix-blend-mode:screen}"
        ".tr-light-leak .ll-o1{inset:-22% -8% 38% 8%;border-radius:50%;"
        "background:radial-gradient(circle,rgba(228,114,106,0.32) 0%,transparent 70%);"
        "mix-blend-mode:screen}"
        ...
        "transform-origin:50% 50%}"
        ".tr-sdf-iris .si-iris{background:#C8453D;mix-blend-mode:overlay}"
        ".tr-sdf-iris .si-ring{"
        "background:radial-gradient(circle,transparent 46%,"
        "rgba(228,114,106,0.92) 50%,transparent 54%);"
        "mix-blend-mode:screen}"
        ...
        ".tr-thermal-distortion .td-to{background:#C8453D;mix-blend-mode:overlay}"
        ...
        "rgba(228,114,106,0.92) 0%,rgba(200,69,61,0.55) 42%,transparent 70%);"
        "mix-blend-mode:screen}"
        ...
        "rgba(228,114,106,0.7) 50%,transparent 100%);"
        "mix-blend-mode:screen;transform-origin:50% 50%}"
        ...
        ".tr-whip-pan .wp-to{background:#C8453D;mix-blend-mode:overlay}"
        ...
        "rgba(228,114,106,0) 12%,rgba(200,69,61,0.88) 48%,"
        ...
        "background:linear-gradient(120deg,#F7F5F3 0%,#E4726A 50%,#C8453D 100%);"
        ...
        ".tr-transitions-3d .t3-b{background:#C8453D;opacity:0}"
        ...
        ".tr-transitions-blur .tb-b{background:#C8453D;opacity:0}"
        ...
        ".tr-transitions-cover .tc-b{background:#C8453D;opacity:0}"
        ...
        "opacity:0}"
        ".tr-transitions-cover .tc-wb{background:#8E2F2A}"
        ".tr-transitions-cover .tc-wa{background:#C8453D}"
        ...
        ".tr-transitions-light .tlt-b{background:#C8453D;opacity:0}"
        ...
        "background:linear-gradient(135deg,rgba(200,69,61,0.6),transparent 60%);"
        "transform-origin:50% 50%}"
        ...
        ".tr-transitions-other .tto-b{background:#C8453D;opacity:0}"
...
def overlay_css(brandbook: dict[str, Any]) -> str:
    ...
    return (
        ...
        ".fullscreen-text.invert .fs-slam-card{background:rgba(26,31,46,0.52);"
        ...
        "text-shadow:0 0 24px rgba(200,69,61,0.45)}"
        ...
        ".fullscreen-text.fs-shared-axis-z.saz-accent{color:#FF6B63;"
        ...
        ".fullscreen-text.fs-code-pa.invert{background:transparent;color:#e1e4e8}"
        ...
        "font-family:'JetBrains Mono',var(--font-mono),monospace;font-weight:500;"
        "text-transform:none;letter-spacing:0;color:#e6edf3}"
        ".fullscreen-text.fs-code-scroll.invert{background:transparent;color:#e6edf3}"
        ...
        "font-family:'JetBrains Mono',var(--font-mono),monospace;font-weight:500;"
        "text-transform:none;letter-spacing:0;color:#e6edf3}"
        ".fullscreen-text.fs-code-typing.invert{background:transparent;color:#e6edf3}"
        ...
        "radial-gradient(ellipse 80% 60% at 50% 40%,rgba(200,69,61,0.10) 0%,"
        ...
        "background:radial-gradient(circle,rgba(200,69,61,0.32) 0%,transparent 68%);"
        "pointer-events:none}"
        ...
        "text-transform:uppercase;color:#ffffff;"
        "text-shadow:0 0 40px rgba(200,69,61,0.45),0 8px 40px rgba(0,0,0,0.55);"
        "will-change:transform,opacity}"
        ...
        ".fullscreen-text.invert .fs-fact{background:rgba(26,31,46,0.52);color:#f7f8fa;"
        "backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px);"
        "border-color:rgba(200,69,61,0.45);"
        "box-shadow:0 22px 56px rgba(0,0,0,0.35),inset 0 1px 0 rgba(255,255,255,0.14)}"
        ...
        "background:rgba(26,31,46,0.52);backdrop-filter:blur(18px);"
        "-webkit-backdrop-filter:blur(18px);border-radius:14px;"
        "padding:24px 38px 26px 32px;border:1px solid rgba(200,69,61,0.4);"

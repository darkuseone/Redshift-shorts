...
def transition_css(brandbook: dict[str, Any]) -> str:
    ...
    return (
        ...
        "background:radial-gradient(circle,rgba(215,38,61,0.65) 0%,transparent 58%);"
        "mix-blend-mode:screen}"
        ...
        ".tr-glitch-shader .gs-b{background:#D7263D;mix-blend-mode:screen}"
        ...
        "background:rgba(215,38,61,0.35);mix-blend-mode:screen}"
        ...
        "rgba(215,38,61,0.28) 58%,transparent 74%);"
        "mix-blend-mode:screen}"
        ".tr-light-leak .ll-hot{inset:-18% -12% 62% 48%;border-radius:50%;"
        "background:radial-gradient(circle,rgba(215,38,61,0.9) 0%,transparent 62%);"
        "mix-blend-mode:screen}"
        ...
        "rgba(215,38,61,0) 38%,rgba(215,38,61,0.88) 50%,"
        ...
        "background:radial-gradient(circle,rgba(215,38,61,0.32) 0%,transparent 70%);"
        "mix-blend-mode:screen}"
        ...
        "rgba(215,38,61,0.92) 50%,transparent 54%);"
        "mix-blend-mode:screen}"
        ...
        "rgba(215,38,61,0.92) 0%,rgba(215,38,61,0.55) 42%,transparent 70%);"
        "mix-blend-mode:screen}"
        ...
        "rgba(215,38,61,0.7) 50%,transparent 100%);"
        "mix-blend-mode:screen;transform-origin:50% 50%}"
        ...
        "rgba(215,38,61,0) 12%,rgba(215,38,61,0.88) 48%,"
        ...
        "background:linear-gradient(120deg,#F7F5F3 0%,#D7263D 50%,#D7263D 100%);"
        ...
        "rgba(215,38,61,0.8) 50%,transparent 60%)}"
        ...
        "rgba(215,38,61,0.4),transparent 50%)}"

...
def overlay_css(brandbook: dict[str, Any]) -> str:
    ...
    return (
        ...
        "border:2px solid rgba(17,18,20,0.16);"
        "box-shadow:0 22px 56px rgba(0,0,0,0.28);max-width:100%;will-change:transform}"
        ".fullscreen-text.invert .fs-fact{background:var(--color-ink);color:#f7f8fa;"
        ...
        "background:#111214;border-radius:14px;padding:24px 38px 26px 32px;"

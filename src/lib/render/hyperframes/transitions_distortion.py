...
def tdist_transition_css() -> str:
    ...
    return (
        ...
        ".tr-transitions-distortion .tdist-a{background:#1b263b;opacity:0}"
        ".tr-transitions-distortion .tdist-b{background:#e07a5f;opacity:0}"
        ...
        ".tr-transitions-distortion .tdist-a .tdist-label{color:#778da9}"
        ".tr-transitions-distortion .tdist-b .tdist-label{color:#ffffff}"
        ".tr-transitions-distortion .tdist-r{background:rgba(229,56,59,0.35);mix-blend-mode:screen;opacity:0}"
        ".tr-transitions-distortion .tdist-b-chroma{background:rgba(72,191,227,0.35);mix-blend-mode:screen;opacity:0}"
    )

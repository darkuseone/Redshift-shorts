...
def mtr_overlay_css() -> str:
    ...
    return (
        ...
        "background:radial-gradient(ellipse 90% 60% at 30% 20%,rgba(215,38,61,0.15) 0%,rgba(215,38,61,0) 60%),"
        ...
        "background:#D7263D;color:#fff;font-size:32px;font-weight:700;display:flex;align-items:center;"
        "justify-content:center;box-shadow:0 12px 30px rgba(215,38,61,0.45)}"
    )

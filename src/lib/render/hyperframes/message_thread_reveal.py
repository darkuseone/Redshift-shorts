...
def mtr_overlay_css() -> str:
    ...
    return (
        ...
        ".message-thread-reveal .mtr-ec-proof{font-size:28px;color:#8e8e93;margin-bottom:50px}"
        ...
        ".message-thread-reveal .mtr-feat-bot{font-size:20px;color:#8e8e93;margin-top:6px}"

...
def nr_overlay_css() -> str:
    ...
    return (
        ...
        ".notes-reveal .nr-notescene{position:absolute;inset:0;background:#F7F5F3;"
        ...
        ".notes-reveal .nr-date-header{font-size:24px;font-weight:500;color:#7A7D82;margin-bottom:44px}"
        ".notes-reveal .nr-lines{display:flex;flex-direction:column;gap:28px}"
        ".notes-reveal .nr-line{font-size:42px;line-height:56px;color:#111214;font-weight:400}"
        ".notes-reveal .nr-w{opacity:0;display:inline-block}"
        ".notes-reveal .nr-cardscene{position:absolute;inset:0;background:#F7F5F3;"
        ...
        "background-image:radial-gradient(circle,rgba(122,125,130,0.22) 2px,transparent 2.6px);"
        ...
        "padding:16px 24px;background:#F7F5F3;border-radius:18px}"

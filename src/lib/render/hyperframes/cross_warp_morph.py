...
def cwm_transition_css() -> str:
    ...
    return (
        ...
        ".tr-cross-warp-morph .cwm-from{background:#111214;color:#E5322D;opacity:0}"
        ".tr-cross-warp-morph .cwm-to{background:#E5322D;color:#ffffff;opacity:0}"
        ...
        "background:radial-gradient(ellipse at 40% 50%,rgba(255,106,95,0.45) 0%,transparent 70%);"

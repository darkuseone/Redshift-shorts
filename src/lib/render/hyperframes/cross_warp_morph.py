...
def cwm_transition_css() -> str:
    ...
    return (
        ...
        ".tr-cross-warp-morph .cwm-from{background:#111214;color:#C8453D;opacity:0}"
        ".tr-cross-warp-morph .cwm-to{background:#C8453D;color:#ffffff;opacity:0}"
        ...
        "background:radial-gradient(ellipse at 40% 50%,rgba(228,114,106,0.45) 0%,transparent 70%);"

...
def sv_transition_css() -> str:
    ...
    return (
        ...
        ".tr-swirl-vortex .sv-from{background:#073b4c;color:#06d6a0;opacity:0}"
        ".tr-swirl-vortex .sv-to{background:#06d6a0;color:#073b4c;opacity:0}"
        ...
        ".tr-swirl-vortex .sv-vortex{"
        "background:radial-gradient(circle at 50% 50%,rgba(6,214,160,0.65) 0%,rgba(7,59,76,0.3) 40%,transparent 70%);"

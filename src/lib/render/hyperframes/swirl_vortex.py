...
def sv_transition_css() -> str:
    ...
    return (
        ...
        ".tr-swirl-vortex .sv-from{background:#111214;color:#D7263D;opacity:0}"
        ".tr-swirl-vortex .sv-to{background:#D7263D;color:#ffffff;opacity:0}"
        ...
        ".tr-swirl-vortex .sv-vortex{"
        "background:radial-gradient(circle at 50% 50%,rgba(215,38,61,0.65) 0%,rgba(17,18,20,0.3) 40%,transparent 70%);"

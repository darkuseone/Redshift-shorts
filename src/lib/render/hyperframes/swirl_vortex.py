...
def sv_transition_css() -> str:
    ...
    return (
        ...
        ".tr-swirl-vortex .sv-from{background:#111214;color:#E5322D;opacity:0}"
        ".tr-swirl-vortex .sv-to{background:#E5322D;color:#ffffff;opacity:0}"
        ...
        ".tr-swirl-vortex .sv-vortex{"
        "background:radial-gradient(circle at 50% 50%,rgba(229,50,45,0.65) 0%,rgba(17,18,20,0.3) 40%,transparent 70%);"

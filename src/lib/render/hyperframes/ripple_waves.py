...
def tr_ripple_waves(ctx: TemplateCtx) -> Piece:
    ...
    node = (
        ...
        f'<span class="rw-big">SCENE A</span>'
        f'</span>'
        f'<span id="{node_id}-to" class="rw-face rw-to">'
        f'<span class="rw-big">SCENE B</span>'
        f'</span>'
...
def rw_transition_css() -> str:
    ...
    return (
        ...
        ".tr-ripple-waves .rw-from{background:#264653;color:#e9c46a;opacity:0}"
        ".tr-ripple-waves .rw-to{background:#e9c46a;color:#264653;opacity:0}"
        ...
        "background:radial-gradient(circle at 50% 50%,rgba(233,196,106,0.6) 0%,rgba(38,70,83,0.3) 35%,transparent 65%);"
        "mix-blend-mode:screen;opacity:0}"
        ".tr-ripple-waves .rw-w2{"
        "background:radial-gradient(circle at 50% 50%,rgba(255,255,255,0.7) 0%,rgba(233,196,106,0.4) 30%,transparent 60%);"

...
def rw_transition_css() -> str:
    ...
    return (
        ...
        ".tr-ripple-waves .rw-from{background:#111214;color:#E5322D;opacity:0}"
        ".tr-ripple-waves .rw-to{background:#E5322D;color:#ffffff;opacity:0}"
        ...
        "background:radial-gradient(circle at 50% 50%,rgba(229,50,45,0.6) 0%,rgba(17,18,20,0.3) 35%,transparent 65%);"
        "mix-blend-mode:screen;opacity:0}"
        ".tr-ripple-waves .rw-w2{"
        "background:radial-gradient(circle at 50% 50%,rgba(255,255,255,0.7) 0%,rgba(255,106,95,0.4) 30%,transparent 60%);"

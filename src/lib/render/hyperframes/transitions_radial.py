...
def trad_transition_css() -> str:
    ...
    return (
        ...
        ".tr-transitions-radial .trad-a{background:#1b263b;opacity:0}"
        ...
        ".tr-transitions-radial .trad-b{background:#e07a5f}"
        ...
        ".tr-transitions-radial .trad-a .trad-label{color:#778da9}"
        ...
        "width:2240px;height:2240px;margin-left:-1120px;margin-top:-1120px;"
        "border-radius:50%;border:4px solid #e07a5f;"
        "box-shadow:0 0 32px #e07a5f;opacity:0;pointer-events:none;transform-origin:50% 50%}"
    )

...
def ts_transition_css() -> str:
    ...
    return (
        ...
        ".tr-transitions-scale .tscale-a{background:#1b263b;opacity:0}"
        ".tr-transitions-scale .tscale-b{background:#e07a5f;opacity:0}"
        ...
        ".tr-transitions-scale .tscale-a .tscale-label{color:#778da9}"

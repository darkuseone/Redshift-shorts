...
def acr_overlay_css() -> str:
    ...
    return (
        ...
        "background:linear-gradient(180deg,#14110e 0%,#221b13 100%);opacity:0}"
        ".ai-chat-reveal .acr-eclogo{position:absolute;left:255px;top:112px;"
        "font-weight:800;font-size:42px;letter-spacing:0.12em;color:#f7ece5}"
        ...
        "color:#f7ece5;letter-spacing:0.5px}"
        ...
        "line-height:40px;color:#cfc4b8}"
        ".ai-chat-reveal .acr-eccta{position:absolute;left:160px;top:1406px;"
        "width:429px;height:87px;background:#3ce6ac;border-radius:44px;"
        "display:flex;align-items:center;justify-content:center;gap:22px}"
        ".ai-chat-reveal .acr-lbl{color:#0d0d0d;font-weight:700;font-size:33px;"

...
def tp_transition_css() -> str:
    ...
    return (
        ...
        ".tr-transitions-push .tpush-a{background:#1b263b;opacity:0}"
        ".tr-transitions-push .tpush-b{background:#e07a5f;opacity:0}"
        ...
        ".tr-transitions-push .tpush-a .tpush-label{color:#778da9}"

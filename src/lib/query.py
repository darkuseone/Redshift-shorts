...
CONCEPTS: dict[str, list[str]] = {
    ...
    "космос": ["deep space stars", "galaxy nebula", "orbit earth view"],
    "планет": ["planet surface", "exoplanet space", "telescope observatory"],
    "телескоп": ["space telescope", "observatory dome night", "astronomer telescope"],
    "звезд": ["starfield timelapse", "night sky stars", "nebula deep space"],
    "ракет": ["rocket launch", "spacecraft engine", "launch pad"],
    "лаборатор": ["research laboratory", "scientist microscope", "clean room laboratory"],
...
ROLE_METAPHORS: dict[str, list[str]] = {
    ...
    "evidence": ["documents on desk", "screen with data closeup"],
...
INTENT_PATTERNS: list[tuple[str, tuple[str, ...]]] = [
    ("space", ("space", "orbit", "galaxy", "nebula", "planet", "rocket", "telescope",
               "spacecraft", "astronaut", "cosmic", "star")),

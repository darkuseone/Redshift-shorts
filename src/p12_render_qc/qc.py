...
def run_qc(ctx, *, plan: dict[str, Any], cut_plan: dict[str, Any],
    ...
    baseline_lo, baseline_hi = cfg.brand("subtitles.baseline_y", [620, 1280])
    shift_y = cfg.brand("subtitles.baseline_y_avatar_shift", 720)
...
def _qc21_scores(template_id: str) -> bool:
    ...
    return cat in {"text-fullscreen", "hero-devices", "data-viz",

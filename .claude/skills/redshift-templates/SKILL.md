...
description: Каталог из 119 шаблонов, ротация и различия версий A/B. Используй при работе с templates/, выборе шаблона, приёмах вокруг ведущего, ошибке AB_TOO_SIMILAR и проверке QC-17.
---
# redshift-templates

119 шаблонов в 12 категориях (§15). Каталог генерируется
...
| `text-fullscreen` | 26 | полноэкранный текст |
...
3. Редко используемые шаблоны получают приоритет: без этого каталог из 119
...
code-scroll, code-typing и цифру-удар.
...
119 шаблонов — это **рендереры с параметрами**, а не 119 реализаций:

...
`#19e6d2` как в каталоге — аберрация, не чужой бренд. Цвета канала не
подмешиваются),
...
`#E5322D`, не изумруд `#34d399`. HOLD без ухода),
...
`#0A0A0B`, панели `#141517`, текст `#ffffff`/`#C9CCCF` со скриншотов.
...
акцентная черта рисуется `scaleX` слева направо (`#E5322D`, не мятный
...
направо (`#E5322D`, не золото `#f5b942` каталога), роль проявляется
...
end-card с логотипом, рейтингом и CTA-кнопкой в цветах бренда (#E5322D). Каталог
...
`#0a0a0b` / `#48bfe3` и steel `#7a9ab0`. Цвета SCENE A/B каталога, не палитра
...
второй клип без difference, иначе `#E5322D` уходит в циан.

...
| `text-fullscreen` | 29 | полноэкранный текст |
...
3. Редко используемые шаблоны получают приоритет: без этого каталог из 122
...
122 шаблонов — это **рендереры с параметрами**, а не 122 реализаций:

...
description: Каталог из 140 шаблонов, ротация и различия версий A/B. Используй при работе с templates/, выборе шаблона, приёмах вокруг ведущего, ошибке AB_TOO_SIMILAR и проверке QC-17.
---
# redshift-templates

140 шаблонов в 12 категориях (§15). Каталог генерируется
...
3. Редко используемые шаблоны получают приоритет: без этого каталог из 140
...
`stat-countup-card`, четыре и больше — `bar-chart-race` (гонка рядов,
...
140 шаблонов — это **рендереры с параметрами**, а не 140 реализаций:

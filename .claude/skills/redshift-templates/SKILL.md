...
description: Каталог из 117 шаблонов, ротация и различия версий A/B. Используй при работе с templates/, выборе шаблона, приёмах вокруг ведущего, ошибке AB_TOO_SIMILAR и проверке QC-17.
---
# redshift-templates

117 шаблонов в 12 категориях (§15). Каталог генерируется
...
| `text-fullscreen` | 24 | полноэкранный текст |
...
3. Редко используемые шаблоны получают приоритет: без этого каталог из 117
...
shared-axis-z, code-3d-extrude, code-diff, code-particle-assemble и цифру-удар.
...
117 шаблонов — это **рендереры с параметрами**, а не 117 реализаций:

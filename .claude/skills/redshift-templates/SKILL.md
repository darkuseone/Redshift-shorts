...
description: Каталог из 146 шаблона, ротация и различия версий A/B. Используй при работе с templates/, выборе шаблона, приёмах вокруг ведущего, ошибке AB_TOO_SIMILAR и проверке QC-17.
---
# redshift-templates

146 шаблон в 12 категориях (§15). Каталог генерируется
...
3. Редко используемые шаблоны получают приоритет: без этого каталог из 146
...
в блоке United States / Census / штат / California — `us-map`. Не пересекается
...
146 шаблон — это **рендереры с параметрами**, а не 146 реализация:

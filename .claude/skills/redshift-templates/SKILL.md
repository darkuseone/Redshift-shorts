...
description: Каталог из 118 шаблонов, ротация и различия версий A/B. Используй при работе с templates/, выборе шаблона, приёмах вокруг ведущего, ошибке AB_TOO_SIMILAR и проверке QC-17.
---
# redshift-templates

118 шаблонов в 12 категориях (§15). Каталог генерируется
...
| `text-fullscreen` | 25 | полноэкранный текст |
...
3. Редко используемые шаблоны получают приоритет: без этого каталог из 118
...
118 шаблонов — это **рендереры с параметрами**, а не 118 реализаций:

...
description: Каталог из 116 шаблонов, ротация и различия версий A/B. Используй при работе с templates/, выборе шаблона, приёмах вокруг ведущего, ошибке AB_TOO_SIMILAR и проверке QC-17.
---
# redshift-templates

116 шаблонов в 12 категориях (§15). Каталог генерируется
...
| `text-fullscreen` | 23 | полноэкранный текст |
...
3. Редко используемые шаблоны получают приоритет: без этого каталог из 116
...
shared-axis-z, code-3d-extrude, code-diff и цифру-удар.
...
116 шаблонов — это **рендереры с параметрами**, а не 116 реализаций:

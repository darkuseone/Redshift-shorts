...
NEEDS_BY_ID: dict[str, tuple[str, ...]] = {
    ...
    # --- перенесённые приёмы (tools/port_templates.py) ---
    "transitions/gravitational-lens": ("discovery", "place", "superlative"),
    "transitions/thermal-distortion": ("danger",),
    "transitions/transitions-destruction": ("danger", "negation"),
    "transitions/glitch": ("danger", "negation"),
    "text-fullscreen/code-typing": ("device",),
    "text-fullscreen/code-scroll": ("device",),
    "text-fullscreen/code-diff": ("device", "comparison"),
    "text-fullscreen/code-3d-extrude": ("device",),
    "text-fullscreen/code-particle-assemble": ("device", "discovery"),
    "text-fullscreen/terminal-simulator": ("device",),
    "text-fullscreen/apple-terminal-clear-dark": ("device",),
    "text-fullscreen/dark-plus": ("device",),
    "data-viz/world-map": ("place",),

...
CATALOG: dict[str, tuple[int, list[tuple]]] = {
    ...
    "text-fullscreen": (31, [
        ...
        ("code-morph",
         "FLIP-морфинг между состояниями кода — code-morph",
         [1.5, 7.0],
         {"code_morph": True},
         ["code", "code-animation", "morph", "developer"], "code_morph"),
        ("code-typing",
    ...
    "transitions": (41, [
        ...
        ("flash-through-white",
         "Flash through white: переход через белую вспышку на тёмных сценах — flash-through-white",
         [0.22, 0.42], {},
         ["dynamic", "flash", "white", "shader"], "flash_through_white"),
        ("ridged-burn",
         "Ridged burn: пламенный прожиг с искрами и острыми кромками — ridged-burn",
         [0.22, 0.42], {},
         ["dynamic", "burn", "fire", "shader"], "ridged_burn"),
        ("ripple-waves",
        ...
        ("transitions-dissolve",
         "Dissolve: мягкое растворение SCENE A и проявление SCENE B — transitions-dissolve",
         [0.22, 0.42], {},
         ["dynamic", "dissolve", "crossfade"], "transitions_dissolve"),
        ("transitions-distortion",
         "Distortion: глитч и хроматическое расщепление на склейке — transitions-distortion",
         [0.22, 0.42], {},
         ["dynamic", "glitch", "distortion", "chromatic"], "transitions_distortion"),
        ("transitions-grid",
        ...
        ("transitions-push",
         "Push: направленное выталкивание сцен со слайдом — transitions-push",
         [0.22, 0.42], {},
         ["dynamic", "push", "slide", "directional"], "transitions_push"),
        ("transitions-radial",
         "Radial: круговое диафрагменное раскрытие склейки с кольцом свечения — transitions-radial",
         [0.22, 0.42], {},
         ["dynamic", "radial", "iris", "circle"], "transitions_radial"),
        ("transitions-scale",
         "Scale: сквозной наезд через кадр или стягивание в центр — transitions-scale",
         [0.22, 0.42], {},
         ["dynamic", "scale", "zoom", "through"], "transitions_scale"),
    ]),
    "avatar-entry": (6, [

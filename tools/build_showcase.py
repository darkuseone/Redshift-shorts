...
NOTES = {
    ...
    "burst-behind-head": "Лучи расходятся из-за головы на ударной фразе.",
...
# центр головы ≈ 590 px по вертикали). Рисуется один раз и подставляется всем
# карточкам через переменную — иначе одна и та же картинка легла бы в файл
# четырнадцать раз.
SILHOUETTE = (
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1080 1920">'
    '<g fill="#24262B">'
    '<ellipse cx="540" cy="576" rx="163" ry="203"/>'
